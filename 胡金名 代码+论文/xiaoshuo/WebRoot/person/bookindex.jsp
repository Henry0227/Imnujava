...
<head>
  ...
  <body>
  <br>
    <s:action name="book!mybook2" executeResult="false" namespace="/"></s:action>
  <s:if test="#request.booklist.size()>0">
  
  <table width="867" height="155" border="1" align="center">
    <tr>
      <td width="74" height="31">我的原创书籍</td>
      <td width="156">&nbsp;</td>
      <td width="102">&nbsp;</td>
      <td width="112">&nbsp;</td>
      <td width="389">&nbsp;</td>
    ...
    <tr>
      ...
      <td align="center"><a href="article!beforeList?bookid=<s:property value="id"/>&pageSize=10&pageNum=1" >查看章节</a>| <a href="person/newArticle.jsp?bookid=<s:property value="id"/>">上传新章节</a></td>
    </tr>
    </s:iterator>
  </table>
