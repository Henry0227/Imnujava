...
<html>
  ...
  <table width="777" border="0"align="left"  cellpadding="1" cellspacing="1" class="table1" >
    ...
    <tr>
      <td height="496">
      <s:action name="book" executeResult="false" namespace="/" ></s:action>
      ...
      <table width="356" height="260" border="0" class="td_bg1" align="left">
        ...
        <tr>
          <td width="143" height="223"><a href="detailProduct.jsp?productID="><a href="article?bookname=<s:property value="title"/>&bookid=<s:property value="id"/>&pageSize=20&pageNum=1" target="right"><img src="../<s:property value="picture"/>" width="143" height="200" border="0"></a></td>
    ...
    <tr>
      <td height="31" align="right" class="td_bg1"><a target="right" href="book!findUp2?pageSize=4&pageNum=1">上一页</a>&nbsp;|&nbsp;<a target="right" href="book!findDown2?pageSize=4&pageNum=1">下一页</a><br/><hr/></td>
    </tr>
  </table>
  </body>
</html>