  ...
  <table width="777" border="0"align="left"  cellpadding="1" cellspacing="1" class="table1" >
    ...
    <tr>
      ...
      <table width="356" height="260" border="0" class="td_bg1" align="left">
        ...
        <tr>
          <td width="143" height="223"><a href="article?bookname=<s:property value="title"/>&bookid=<s:property value="id"/>&pageSize=20&pageNum=1" target="right"><img src="../<s:property value="picture"/>" width="143" height="200" border="0"></a></td>
          <td width="199"><table width="204" height="204" border="0" class="table2_1"cellspacing="1" cellpadding="1">
            ...
            <tr>
              <td height="116" colspan="2" align="center" class="td_br1"><s:property value="remark"/>
                [<a href="article?bookname=<s:property value="title"/>&bookid=<s:property value="id"/>&pageSize=20&pageNum=1" target="right">阅读</a>]</td>
            </tr>
          </table>
            <hr></td>
        </tr>
    ...
    <tr>
      <td height="31" align="right" class="td_bg1"><a target="right" href="book!findUp2?pageSize=<s:property value="pageSize"/>&pageNum=<s:property value="pageNum"/>">上一页</a>&nbsp;|&nbsp;<a target="right" href="book!findDown2?pageSize=<s:property value="pageSize"/>&pageNum=<s:property value="pageNum"/>">下一页</a><br/><hr/></td>
    </tr>
  </table>
  </body>
</html>